...
<head>
    ...
    <title>Super Admin | Medefence</title>
...
<div class="error-page-int">
    <div class="text-center m-b-md custom-login">
        <img src="<?php echo base_url(); ?>assets/img/logo/logo.png" style="width:250px;height:250px;">
	</div>
	
    <div class="content-error" style="margin-top:10px;">
    <div class="hpanel">
        <div class="panel-body">
        <h3 CLASS="text-center text-danger">SUPER ADMIN LOGIN</h3>
            <form id="sloginform" name="sloginform" class="sloginform">
...
<script>
$('#sloginform').on('submit',function(e){
    e.preventDefault();
   var formData = new FormData($(this)[0]);
         $.ajax({
            async: true,
            url:'<?=base_url()?>medifense/slogin',
            dataType: 'json',
            method:"post",
            data:formData,
